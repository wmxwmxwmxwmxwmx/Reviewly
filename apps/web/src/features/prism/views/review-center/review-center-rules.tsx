...
const RULES = [
  {
    icon: Ban,
    title: "高风险拦截",
    description: "安全评分 < 60 或存在 Critical 问题时，禁止批准 PR。",
  },
  {
    icon: Shield,
    title: "安全门禁",
    description: "合并前须通过 AI 规则扫描与人工审批双重确认。",
  },
  {
    icon: AlertTriangle,
    title: "要求修改",
    description: "审批人可提交「要求修改」，PR 状态变为 CHANGES_REQUESTED。",
  },
] as const
    ...
    <div className="p-4 sm:p-5 space-y-4 max-w-5xl">
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 p-4 rounded-lg border border-ai-blue/25 bg-ai-blue/5">
        <div className="min-w-0">
          <h2 className="text-sm font-semibold text-foreground">审批规则</h2>
