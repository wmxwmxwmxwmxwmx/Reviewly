...
def test_rate_limit_without_pat() -> None:
    ...
    assert detail.get("code") == "GITHUB_RATE_LIMIT"
...
def test_rate_limit_with_pat() -> None:
    ...
    assert exc.value.detail.get("code") == "GITHUB_RATE_LIMIT"
...
def test_not_found() -> None:
    ...
    assert exc.value.detail.get("code") == "PR_NOT_FOUND"
...
def test_forbidden_private_repo() -> None:
    ...
    assert exc.value.detail.get("code") == "GITHUB_FORBIDDEN"
...
def test_invalid_pat() -> None:
    ...
    assert exc.value.detail.get("code") == "GITHUB_AUTH_FAILED"
